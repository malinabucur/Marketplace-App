...
const SearchBar: React.FC<SearchBarProps> = ({ handleSearch, searchBook, searchField }) => {
  ...
  return (
    <form className="flex items-center border-b-2 border-[#6B6B6B]" onSubmit={handleLocalSearchBook} action="">
