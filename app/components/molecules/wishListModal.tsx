...
const WishListModal: React.FC<{ onClose: () => void; children?: ReactNode; wishList: string[]; onBookClick: (title: string) => void }> = ({ onClose, children, wishList, onBookClick }) => {
  useEffect(() => {
  ...
  return (
    <div className="relative z-10" aria-labelledby="WishListModal" role="dialog" aria-modal="true">
      ...
      <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
        <div className="flex min-h-full items-end justify-center p-4 text-center items-center">
          <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all ">
            <div className="bg-white pl-10 py-5 w-[40rem]">
              <div className="mt-3 text-left h-60">
